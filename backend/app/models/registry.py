...
MODEL_REGISTRY: dict[str, ModelConfig] = {
    ...
    "poolside-laguna-xs2": ModelConfig(
        display_name="Poolside Laguna XS.2",
        openrouter_id="poolside/laguna-xs-2:free",
        family="poolside",
        tier=ModelTier.FREE,
        context_window=131072,
        description="Poolside Laguna XS.2",
    ),
    "poolside-laguna-m1": ModelConfig(
        display_name="Poolside Laguna M.1",
        openrouter_id="poolside/laguna-m-1:free",
        family="poolside",
        tier=ModelTier.FREE,
        context_window=131072,
        description="Poolside Laguna M.1",
    ),
    "lfm2.5-thinking": ModelConfig(
        display_name="LFM2.5 Thinking",
        openrouter_id="liquid/lfm-2.5-1.2b-thinking:free",
        family="liquid",
        tier=ModelTier.FREE,
        context_window=32768,
        description="LiquidAI LFM2.5 1.2B Thinking",
    ),
    "lfm2.5-instruct": ModelConfig(
        display_name="LFM2.5 Instruct",
        openrouter_id="liquid/lfm-2.5-1.2b-instruct:free",
        family="liquid",
        tier=ModelTier.FREE,
        context_window=32768,
        description="LiquidAI LFM2.5 1.2B Instruct",
    ),
    ...
    "gemma-3-4b": ModelConfig(
        ...
        openrouter_id="google/gemma-3-4b-it:free",
        family="google",
        tier=ModelTier.FREE,
        context_window=32768,
